function SetSolver()
    ...
    Solutionsystem.max_iter          =10;
    Solutionsystem.transient         =0;        %1:transient, 0:steady
    Solutionsystem.max_solutiontime  =10;        %time[s], set 0 for steady!
    ...
    Solutionsystem.scalarmode        =1;        %additional scalar. 1:on, 0:off
